    ...
    <button
      ...
      className={cn(
        ...
        disabled
          ...
          : "text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-gray-50 cursor-pointer",
      )}
      disabled={disabled}
      onClick={(e) => {
        e.stopPropagation();
      ...
      >
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cn("stroke-gray-200 dark:stroke-gray-800 stroke-1")}
                horizontal={true}
                vertical={false}
              />
            ) : null}
            ...
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  className="fill-gray-800 dark:fill-gray-200 text-sm font-medium"
                >
                  {xAxisLabel}
                </Label>
              )}
                  ...
                  <Area
                    ...
                    activeDot={(props: any) => {
                      ...
                      return (
                        <Dot
                          className={cn(
                            "dark:stroke-gray-950 stroke-white",
